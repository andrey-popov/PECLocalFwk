...
public:
    ...
    /**
     * \brief Returns b-tagging efficiency for the given working point and given jet properties
     * 
     ...
     */
    double GetEfficiency(BTagger::WorkingPoint wp, double pt, double eta, int flavour) const;
